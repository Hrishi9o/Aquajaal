          ...
          child: ConstrainedBox(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  // Letterhead: Logo & Company Information
                  Row(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Image.asset(
                          ...
                          errorBuilder: (_, __, ___) => const Icon(Icons.water, color: AppColors.primary, size: 36),
                        ),
                      ),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              '${invoice.stateName} (Code: ${invoice.stateCode})',
                          ...
                          child: Column(
                            children: [
                              ...
                              if (invoice.discount > 0)
                                _calcRow('Discount', '-${CurrencyFormatter.formatDetailed(invoice.discount)}', color: AppColors.error),
                              if (invoice.taxRate > 0) ...[
                                _calcRow('CGST (${(invoice.taxRate / 2).toStringAsFixed(1)}%)', CurrencyFormatter.formatDetailed(invoice.cgst)),
                                _calcRow('SGST (${(invoice.taxRate / 2).toStringAsFixed(1)}%)', CurrencyFormatter.formatDetailed(invoice.sgst)),
                              ] else
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(AppStrings.invoiceFooterNote, style: const TextStyle(fontSize: 11, color: AppColors.textSecondaryLight)),
                          Text('Total Items: ${invoice.totalUnits} Units', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                        ],
                      ),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          Text('For ${settings.distributorName}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                          const SizedBox(height: 48),
                          Container(width: 160, height: 1, color: Colors.grey),
                          const SizedBox(height: 4),
                          const Text('Authorized Signatory', style: TextStyle(fontSize: 11, color: AppColors.textSecondaryLight)),
                        ],
                      ),
                    ],
                  ),
